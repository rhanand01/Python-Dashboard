...
def create_member_dashboard():
    ...
    welcome_message = pn.pane.Markdown("# Welcome to Elevatoz Dashboard!", sizing_mode='stretch_width')
...
def send_password_reset_email(email, username):
    def send_email():
        ...
        port = 587
        sender_email = "alluanand1439@gmail.com"
        password = "kiwa ywae liyv tebk"
        admin_email = "alluanand0349@gmail.com"
